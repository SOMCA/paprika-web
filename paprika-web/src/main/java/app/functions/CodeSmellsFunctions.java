...
public class CodeSmellsFunctions extends Functions {
	...
	public String[] getToSearch(String nameLabel, long id) {
		...
		case "LM":
			command = beginCommandmethod
					+ " RETURN l.full_name as Location,l.modifier as Modifier,l.return_type as Type, CASE l.number_of_lines WHEN true THEN l.number_of_instructions ELSE  l.number_of_lines END as Number_of_lines";
			search = methodSearch;
			break;
		case "MIM":
			command = beginCommandmethod
