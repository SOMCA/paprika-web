...
public class ClassProcessor extends AbstractProcessor<CtClass> {
	...
	private void blobDetection(CtClass element) {
		...
		//System.out.println("Element size methods:" + element.getMethods().size());
		...
		//System.out.println("Element size fields:" + element.getFields().size());
		...
		else 	annotation.setElementValues(values);
	}
